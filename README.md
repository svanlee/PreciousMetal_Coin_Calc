...
Features:
	...
	•	Coin scanner powered by Claude AI vision — identifies type, date, mint mark, grade, and toning
	•	Authenticity & patina analysis using thin-film interference physics
	•	Flip tracker with cost basis, melt value, and P&L
	•	Customer offer calculator with bid tiers and counter-offer verdict
	•	Bulk coin entry for lot purchases
	•	Weight verification against mint specs
	•	g / troy oz / dwt converter baked in throughout
